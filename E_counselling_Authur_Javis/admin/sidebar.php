...
?>
 <li class="nav-header">
                ...
                <a href="index.php"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboards</span></a></li>
                 ...
                 <li>
                    <a href="user-record.php"><i class="fa fa-user"></i> <span class="nav-label">Manage User</span></a>
                </li>
				                 <li>
                    <a href="msg-record.php"><i class="fa fa-user"></i> <span class="nav-label">Manage Messages</span></a>
                </li>
     ...
     <li>
                ...
                <li>
                    <a href="../index.php"><i class="fa fa-exchange"></i> <span class="nav-label">Switch To Chat</span></a>
                </li>