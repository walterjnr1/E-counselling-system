...
<div class="h-100 d-flex flex-column">
    <div class="col-12">
            <div class="hs-5 fw-bold flex-grow-1 col-auto pe-3 style1"></div> 
			<div class="hs-5 fw-bold flex-grow-1 col-auto pe-2">Full Name: <?php echo $_SESSION['firstname']?> <?php echo $_SESSION['middlename'] ?> <?php echo $_SESSION['lastname'] ?> </div> 
						<div class="hs-5 fw-bold flex-grow-1 col-auto pe-2">User ID/Reg Number: <?php echo $_SESSION['user_ID'] ?></div>
						<div class="hs-5 fw-bold flex-grow-1 col-auto pe-2"></div>
        ...
        <div class="row h-100">
            <div class="col-md-4 h-100 d-flex flex-column">
                ...
                <div class="card shadow-lg rounded-0 flex-grow-1">
                    <div class="card-header  rounded-0 py-1 w-100 d-flex align-items-center bg-success bg-gradient text-light">
                        <h5 class="card-title">
                            Conversation List
                        </h5>
                    </div>
                            ...
                            <a href="./?eid=<?php echo md5($row['id']) ?>" class="list-group-item list-group-item-action list-item rounded-0 convo_with" data-id = '<?php echo $row['id'] ?>'>
                                <div class="w-100 d-flex position-relative">
                                    <div class="col-2 px-1">
                                        <img src="<?php echo $row['avatar']?>" class='user-search-avatar rounded-circle bg-light border border-dark' alt="">
                                        <span class="rounded-circle notif-count badge bg-danger"><?php echo $row['un_read'] ?></span>
                                    </div>
                                    <div class="col-10 lh-1">
                                        <div class='text-truncate' title="<?php echo $row['name'] ?>||<?php echo $row['user_ID'] ?>"><b class="user-name"><?php echo $row['name']?> <span class="text-muted search-user-email">(<?php echo $row['user_ID'] ?>)</span> </b></div>
            ...
            <div class="col-md-8 h-100" id="right-panel">
                ...
                $eid = isset($_GET['eid']) ? $_GET['eid'] :'-1';
				 $_SESSION['eid'] = isset($_GET['eid']) ? $_GET['eid'] :'-1';
                ...
                <div class="card h-100 shadow-lg rounded-0">
                    <div class="card-header d-flex w-100 align-items-center">
                        <div class="col-auto px-1">
                            <img src="<?php echo $user_to['avatar'] ?>" class="rounded-circle border border-dark view-avatar" alt="">
                        </div>
                        <div class="col-auto flex-grow-1 lh-1">
                            <div><b class="user-name"><?php echo $user_to['fullname'] ?></b></div>
                            <span class="text-muted search-user-email"><?php echo $user_to['user_ID'] ?>||<?php echo $user_to['email'] ?></span>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="position-relative col-auto" id="scroll-bottom-holder">
                        ...
                        <div class="col-auto bg-light bg-gradient border-top px-1 py-1" id="message-form-holder">							
							             <form  action="send_msg.php" method="POST" id="manage-topic22" enctype="multipart/form-data">
                                ...
                                <div class="row align-items-center">
									...
									<div class="col-auto flex-grow-1 mx-0"></div>
                                    <div class="col-auto">
