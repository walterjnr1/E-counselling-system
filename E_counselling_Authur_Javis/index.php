...
<head>
    ...
    <title><?php echo ucwords(str_replace('_',' ',$page)) ?> |E-Counselling System</title>
...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success bg-gradient" id="topNavBar">
        <div class="container">
           <img src="images/logo.png" alt="logo" width="241" height="67"> <a class="navbar-brand" href="./">
					E-Counselling System            </a>
            ...
            <?php if(isset($_SESSION['id'])): ?>
                <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle bg-transparent  text-light border-0" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="me-1"><img src="<?php echo $_SESSION['avatar']; ?>" alt="avatar" class="avatar rounded-circle"></span>    Hello <?php echo $_SESSION['firstname'] ?>
                    </button>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                        <li><a class="dropdown-item" href="./?page=profile">My Profile</a></li>
						 <li><a class="dropdown-item" href="./?page=home">Return to Chat</a></li>
