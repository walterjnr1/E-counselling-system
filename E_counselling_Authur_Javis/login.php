...
<head>
    ...
    <title>LOGIN |Office Chat Application</title>
...
<body class="bg-light bg-gradient">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center text-light">Online/Intranet Office Chat Application</h3>
        <p class="py-5 text-center text-light"><img src="images/logo.png" alt="logo" width="92" height="69"></p>
